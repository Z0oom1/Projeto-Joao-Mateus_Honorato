...
export default function Booking() {
  ...
  if (submitted) {
    return (
      <section className="booking section" id="agendar" aria-label="Agendamento confirmado">
        <div className="container">
          <div className="booking__success reveal">
            ...
            <button
              ...
              onClick={() => { setSubmitted(false); setStep(1); setForm({ name: '', phone: '', treatment: '', date: '', time: '' }) }}
              id="booking-new"
            >
              Novo Agendamento
            </button>
      ...
      <div className="container">
        <div className="booking__layout">
          ...
          <div className="booking__header">
            <span className="booking__label reveal">Agendamento</span>
            <h2 className="booking__title reveal reveal-delay-1">
              Simples assim.<br />
              <em>Sem complicação.</em>
            </h2>
            <div className="divider reveal reveal-delay-2"></div>
            <p className="booking__subtitle reveal reveal-delay-3">
              Escolha o tratamento, a data e o horário.
              Nós cuidamos do resto.
            </p>

            {/* Indicador de passos */}
            <div className="booking__steps reveal reveal-delay-4">
              {[1, 2, 3].map((s) => (
                <div
                  key={s}
          ...
          {/* Formulário */}
          <form className="booking__form reveal reveal-delay-2" onSubmit={handleSubmit} id="booking-form">
            {/* Passo 1: Dados Pessoais */}
            {step === 1 && (
              <div className="booking__form-step" key="step1">
                <div className="booking__field">
                  <label htmlFor="booking-name" className="booking__label-text">Nome Completo</label>
                  <input
                    type="text"
                    id="booking-name"
                ...
                <div className="booking__field">
                  <label htmlFor="booking-phone" className="booking__label-text">WhatsApp</label>
                  <input
                    type="tel"
                    id="booking-phone"
                    className="booking__input"
            ...
            {step === 2 && (
              <div className="booking__form-step" key="step2">
                ...
                <div className="booking__treatments">
                  {treatments.map((t) => (
                    <button
                      ...
                      id={`treatment-${t.toLowerCase().replace(/\s+/g, '-')}`}
                    >
                      {t}
                    </button>
                  ))}
                ...
                <div className="booking__nav-buttons">
                  <button type="button" className="btn-outline" onClick={() => setStep(1)} id="booking-back-2">
                    Voltar
                  </button>
                  <button
                    type="button"
            ...
            {step === 3 && (
              <div className="booking__form-step" key="step3">
                <div className="booking__field">
                  <label htmlFor="booking-date" className="booking__label-text">Data preferida</label>
                  <input
                    type="date"
                    id="booking-date"
                    className="booking__input"
                ...
                <div className="booking__nav-buttons">
                  <button type="button" className="btn-outline" onClick={() => setStep(2)} id="booking-back-3">
                    Voltar
                  </button>
                  <button
                    type="submit"
